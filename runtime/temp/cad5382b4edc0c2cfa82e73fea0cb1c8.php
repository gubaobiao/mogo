<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"C:\projects\mogo\public/../application/index\view\index\article.html";i:1530496114;s:55:"C:\projects\mogo\application\index\view\Common\nav.html";i:1529618486;s:58:"C:\projects\mogo\application\index\view\Common\footer.html";i:1530063830;}*/ ?>
<!DOCTYPE html>
    ...
    html body{
        ...
        .videodes{
           /*color: red;*/
            ...
            margin-top: 10px;
            margin-right: 10px;
        }db.createUser({ user: "baobiao", pwd: "baobiao123456", roles: [{ role: "userAdminAnyDatabase", db: "zhbjzx" }] })
        .videonavl{
            float: left;
        }
        .videonavr{
