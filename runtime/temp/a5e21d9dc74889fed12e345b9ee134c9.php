<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"C:\projects\mogo\public/../application/index\view\index\person.html";i:1530571431;s:55:"C:\projects\mogo\application\index\view\Common\nav.html";i:1529618486;s:58:"C:\projects\mogo\application\index\view\Common\footer.html";i:1530063830;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0017)http://www.vs.cm/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf8">

    <title>UFC_<?php echo $detail['username']; ?></title>
    <meta name="description" content="UFC拳手排行,搏击视频资讯综合网站">
    <meta name="keywords" content="UFC拳手排行,UFC视频,拳击视频，昆仑决视频">
...
<div id="content">
 ...
 <div class="main_menu">
            <ul class="area">
            <li><a href="<?php echo \think\Config::get('host'); ?>" target="_self" title="首页">首页</a></li>
            <?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li><a href="/<?php echo $vo['rewriteurl']; ?>.html" target="_self" title="<?php echo $vo['catename']; ?>"><?php echo $vo['catename']; ?></a></li>
